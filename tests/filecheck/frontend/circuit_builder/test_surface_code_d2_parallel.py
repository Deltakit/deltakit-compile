...
# Parallelised stabiliser measurements with NZ scheduling.

import sys

from deltakit_compile.frontend.circuit_builder import CircuitProgramBuilder
from deltakit_compile.frontend.common import Circuit, CircuitBuilder, ParallelAlignment, QubitReg
...
def build_memory(is_first: bool, is_last: bool) -> Circuit:
    ...
    with memory_builder.parallel(ParallelAlignment.LOCKSTEP) as p:
        with p():
