// RUN: deltakit_compile compile-passes -t %s -p stim-import-pipeline --pass-args '{"verify_between_passes": true, "extract_tags_to_attributes": true, "realign_detectors": false}' -O %t && filecheck %s --input-file %t
...
// CHECK-NEXT:      %57 = qec.observable_include(%16) using (%54) {my_type = !test.type<"test">} -> !qec.observable
