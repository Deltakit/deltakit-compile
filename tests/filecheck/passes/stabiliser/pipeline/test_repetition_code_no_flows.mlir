...
//
// This test is intentionally similar to test_repetition_code.mlir, but with no flow annotations
// and with no qec.detector operations in the input.
...
builtin.module {
    ...
    %qa_4, %qd1_4, %qd2_4 = qstruct.circuit(%qa_3, %qd1_3, %qd2_3 : !qcore.qubit, !qcore.qubit, !qcore.qubit)
        -> !qcore.qubit, !qcore.qubit, !qcore.qubit {
    ^bb0(%qa_b: !qcore.qubit, %qd1_b: !qcore.qubit, %qd2_b: !qcore.qubit):
        qref.reset<Z> (%qa_b)
        qref.gate<#qcore.gate.cx> (%qd1_b, %qa_b)
    ...
    %qa_5, %qd1_5, %qd2_5 = qstruct.circuit(%qa_4, %qd1_4, %qd2_4 : !qcore.qubit, !qcore.qubit, !qcore.qubit)
        -> !qcore.qubit, !qcore.qubit, !qcore.qubit {
    ^bb0(%qa_b: !qcore.qubit, %qd1_b: !qcore.qubit, %qd2_b: !qcore.qubit):
...
// CHECK-NEXT:         [[D4:%[\w\d_]+]] = qec.detector<[1.0, 0.0]> (%m3_b, %m5_b, %m4_b)
