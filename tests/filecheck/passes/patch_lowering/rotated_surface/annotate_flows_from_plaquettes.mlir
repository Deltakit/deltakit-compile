// RUN: deltakit_compile compile-passes -t %s -p annotate-flows-from-plaquettes -O %t && filecheck %s --input-file %t

// Check that a circuit containing single plaquette is correctly annotated.
builtin.module {
...
// CHECK-NEXT:      %3, %4, %5, %6 = qstruct.circuit(%0, %1, %2 : !qcore.qubit, !qcore.qubit, !qcore.qubit) {stab.droppable_flows, stab.flows = #stab.concrete_flow_array<[<+:3>{I -> Z0 Z1 : 3}, <+:3>{Z0 Z1 -> I : 3}]>} -> !qcore.qubit, !qcore.qubit, !qcore.qubit, i1 {
...
// Check that the fast-path when both qubit and measurements maps are the identity is taken.
builtin.module {
// CHECK:       builtin.module {
...
// CHECK-NEXT:  %p0, %p0_1, %p0_2 = "test.op"() : () -> (!qcore.qubit, !qcore.qubit, !qcore.qubit)
    ...
    %p0_3, %p0_4, %p0_5 = qstruct.repeat<2> (%p0, %p0_1, %p0_2 : !qcore.qubit, !qcore.qubit, !qcore.qubit) -> !qcore.qubit, !qcore.qubit, !qcore.qubit {
        ^bb0(%0: !qcore.qubit, %1: !qcore.qubit, %2: !qcore.qubit):
        %3, %4, %5, %6 = qstruct.circuit(%0, %1, %2 : !qcore.qubit, !qcore.qubit, !qcore.qubit) -> i1, !qcore.qubit, !qcore.qubit, !qcore.qubit {
            ^bb1(%7: !qcore.qubit, %8: !qcore.qubit, %9: !qcore.qubit):
            %10 = plaquette.round(%7, %8, %9) {plaquette.z_observable_is_vertical = true} -> i1 {
                ^bb2(%11: !qcore.qubit, %12: !qcore.qubit, %13: !qcore.qubit):
                %14 = plaquette.plaquette<[Z0 Z1 : 2], #plaquette.synchronised_schedule<[1, 3]>> on (%11, %12) using (%13) {plaquette.shape_type = #plaquette.rotated_surface_plaquette_shape<TOP>} -> i1
            ...
            qstruct.yield %10, %7, %8, %9 : i1, !qcore.qubit, !qcore.qubit, !qcore.qubit
        }
        qstruct.yield %4, %5, %6 : !qcore.qubit, !qcore.qubit, !qcore.qubit
    }
// CHECK-NEXT:  %p0_3, %p0_4, %p0_5 = qstruct.repeat<2> (%p0, %p0_1, %p0_2 : !qcore.qubit, !qcore.qubit, !qcore.qubit) -> !qcore.qubit, !qcore.qubit, !qcore.qubit {
// CHECK-NEXT:      ^bb0(%0: !qcore.qubit, %1: !qcore.qubit, %2: !qcore.qubit):
// CHECK-NEXT:      %3, %4, %5, %6 = qstruct.circuit(%0, %1, %2 : !qcore.qubit, !qcore.qubit, !qcore.qubit) {stab.droppable_flows, stab.flows = #stab.concrete_flow_array<[<+:0>{I -> Z0 Z1 : 3}, <+:0>{Z0 Z1 -> I : 3}]>} -> i1, !qcore.qubit, !qcore.qubit, !qcore.qubit {
// CHECK-NEXT:          ^bb1(%7: !qcore.qubit, %8: !qcore.qubit, %9: !qcore.qubit):
// CHECK-NEXT:          %10 = plaquette.round(%7, %8, %9) {plaquette.z_observable_is_vertical = true} -> i1 {
// CHECK-NEXT:              ^bb2(%11: !qcore.qubit, %12: !qcore.qubit, %13: !qcore.qubit):
// CHECK-NEXT:              %14 = plaquette.plaquette<[Z0 Z1 : 2], #plaquette.synchronised_schedule<[1, 3]>> on (%11, %12) using (%13) {plaquette.shape_type = #plaquette.rotated_surface_plaquette_shape<TOP>} -> i1
// CHECK-NEXT:              plaquette.yield %14 : i1
// CHECK-NEXT:          }
// CHECK-NEXT:          qstruct.yield %10, %7, %8, %9 : i1, !qcore.qubit, !qcore.qubit, !qcore.qubit
// CHECK-NEXT:      }
// CHECK-NEXT:      qstruct.yield %4, %5, %6 : !qcore.qubit, !qcore.qubit, !qcore.qubit
// CHECK-NEXT:  }
